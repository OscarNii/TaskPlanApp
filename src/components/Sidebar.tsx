            ...
            <div className="flex-1 overflow-y-auto px-4 pb-4 space-y-2 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
              {projects.length > 0 ? (
                projects.map((project) => (
                  <div
                    key={project.id}
                    className="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-white/10 dark:hover:bg-white/5 transition-colors cursor-pointer backdrop-blur-sm group"
                  >
                    <div 
                    ...
                    <span className="text-xs text-white/60 bg-white/10 px-2 py-1 rounded-full flex-shrink-0">
                      {project.taskCount}
                    </span>
                  </div>
                ))
